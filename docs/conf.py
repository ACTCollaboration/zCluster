...
latex_documents = [
    (master_doc, 'zCluster.tex', 'zCluster Documentation',
...
man_pages = [
    (master_doc, 'zCluster', 'zCluster Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'zCluster', 'zCluster Documentation',
     author, 'zCluster', 'One line description of project.',
     'Miscellaneous'),
]
